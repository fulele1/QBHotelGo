package com.xaqb.hotel.Listview;
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        LetterIndexView.this.setBackgroundColor(getResources().getColor(R.color.text));
                    ...
                    case MotionEvent.ACTION_UP:
                        LetterIndexView.this.setBackgroundColor(getResources().getColor(R.color.white));
                        if (LetterIndexView.this.touchLetterIndex != null) {
                            //调用接口
