 ...
 */
public class ModifyPswActivity extends BaseActivityNew {
    ...
    public void initViews() {
        setContentView(R.layout.modifypsw_activity);
        instance = this;
        assignViews();
    ...
    private void resetPsw() {
        ...
        if (oldPsw == null || oldPsw.equals("")) {
            ...
            OkHttpUtils
                    .post()
                    .url(HttpUrlUtils.getHttpUrl().getModifyPswUrl() +
